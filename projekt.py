...
zb_l = ['zbrajanje', 'zbrajanjem', 'zbraja', 'zbroj', 'zbrojeni']
od_l = ['oduzimanje', 'oduzimanjem', 'oduzima', 'razlika', 'oduzeti']
mn_l = ['množenje', 'množenjem', 'množi', 'umnožak', 'pomnoženi']
dj_l = ['dijeljenje', 'dijeljenjem', 'dijeli', 'količnik', 'podijeljeni']
l_c = []
